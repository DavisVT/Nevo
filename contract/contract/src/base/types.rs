...
/// Represents a milestone in the funding disbursement process.
/// Each milestone tracks a portion of funding that can be unlocked at a specific date.
#[contracttype]
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct Milestone {
    /// Unix timestamp when this milestone can be unlocked
    pub unlock_date: u64,
    /// Whether this milestone has been unlocked and disbursed
    pub unlocked: bool,
    /// Amount of funding associated with this milestone
    pub amount: i128,
}
